    ...
    <td valign="top" align="center" style="margin: 0 auto;">
      <table cellspacing='0' cellpadding='0'
        ...
        <tr>
          <td align='left' valign='center'
              style='padding: 10px 3%; font-size: 13px; line-height: 1.2; font-weight: 400;  color: #222222'>
            To be set as an admin, <a href="${setPasswordLink}" target="_blank"
                                    style="text-decoration:none;font-weight: 500; color: #4590E4;">follow this link here</a>.
          </td>
        </tr>
        ...
        <tr>
          <td align='left' valign='center'
              style='padding: 10px 3%; font-size: 13px; line-height: 1.2; font-weight: 400;  color: #222222'>
            Once you’re inside, it’s extremely important that you set up 2FA and upload your photo.
          </td>
        </tr>
        ...
        <tr>
          <td align='left' valign='center'
              style='padding: 10px 3%; font-size: 13px; line-height: 1.2; font-weight: 400;  color: #222222'>
            Any questions let a team member know.
          </td>
        </tr>
